...
export default function VisualizarAgendamentos() {
    ...
    return (
        <div className="container mt-5">
            <h2 className="mb-4 text-center text-secondary">Agenda do Profissional</h2>
            ...
            <div className="text-center mt-5">
                <button className="btn btn-outline-primary me-3" onClick={() => navigate("/horarios-profissional")}>
